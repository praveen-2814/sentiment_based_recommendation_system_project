...
class SentimentRecommenderModel:
    ...
    def __init__(self):
        ...
        self.data = pd.read_csv("sentiment_dataset/sample30.csv")
    ...
    """function to get the top 20 product recommendations for the user"""
    ...
    """function to classify the sentiment to positive or negative using the trained ML model"""
    ...
    """function to preprocess the text before it iss sent to ML model"""
